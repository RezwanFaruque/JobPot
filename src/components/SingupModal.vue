                                            ...
                                            <ValidationObserver v-slot="{ invalid }">
                                                <form @submit.prevent="handleForm">
                                                    <div class="form-row first-row">
                                                        ...
                                                        >
                                                            <input 
                                                                :class="{'first-name': true, error: errors.length > 0}" 
                                                                type="text" 
                                                        ...
                                                        >
                                                            <input 
                                                                ...
                                                                :class="{'last-name': true, error: errors.length > 0}" 
                                                    ...
                                                    <div class="form-row">
                                                        ...
                                                        >
                                                            <input 
                                                                type="email" 
                                                                placeholder="Email" 
                                                                :class="{'email': true, error: errors.length > 0}"
                                                    ...
                                                    <div class="form-row">
                                                        ...
                                                        >
                                                            <input 
                                                                ...
                                                                :class="{'password': true, error: errors.length > 0}"
...
export default class Banner extends Vue {
    ...
    handleForm(){
        ...
        this.registration(this.formData).then((data) => {
            console.log(data);
        }).catch((e) => {
            console.log(e);
        })
